# Introduction
	...
	my ($a, $b);	# Multidéclaration. my $a, $b; incorrect (cfr Erlang tuple)
...
## Global
	...
	$.	numéro ligne dernier fichier lu
	$!	errno
...
# Fonctions
## Declaration
	sub maJolieFonction { my ($x, $y, $z) = @_;  return $z; }	# Copie local de @_ sinon modifie paramètres
...
Le nom de la classe est suivi d'une flèche, du nom de la méthode et des éventuels arguments entre parenthèses.
N'écrivez pas Vehicule::getNbVehicules() car le nom de la classe n'est pas transmis et surtout car les mécanismes d'héritage ne sont pas mis en œuvre.

# Perl
    ...
    my ($a, $b);	# Multid�claration. my $a, $b; incorrect (cfr Erlang tuple)
...
## Global
    ...
    $.	num�ro ligne dernier fichier lu
    $!	errno
...
## Arrays & Lists (2)
    ...
    @liste = qw (Une phrase);   # qw means Quote word. No quotes around [Une phrase]. Also qw/blahblah/;
...
Le nom de la classe est suivi d'une fl�che, du nom de la m�thode et des �ventuels arguments entre parenth�ses.
N'�crivez pas Vehicule::getNbVehicules() car le nom de la classe n'est pas transmis et surtout car les m�canismes d'h�ritage ne sont pas mis en �uvre.
S'il est possible d'�crire Velo->getNbVehicules(), il n'est pas permis d'�crire Velo::getNbVehicules(). 

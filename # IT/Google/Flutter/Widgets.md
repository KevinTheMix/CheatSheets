# [Widgets](https://docs.flutter.dev/ui/widgets) & Classes
...
* Flutter: Widgets of the Week
  ...
  * **TabPageSelector**
* **ErrorWidget**
* Restoration = scroll position & state restore (**PageStorageKey**, **RestorationManager**)
...
* `paintImage()` (from _painting.dart_) = paints an image into given rectangle on canvas
...
* Visibility
  ...
  * **Opacity** & **AnimatedOpacity** = alpha (warning: [Opacity widget can lead to poor performances](https://docs.flutter.dev/perf/best-practices#minimize-use-of-opacity-and-clipping))
...
* Mouse/Pointers
  ...
  * **IgnorePointer** = ignore pointer/touch events on a specific child (but [click can still bubble up in a Stack](https://stackoverflow.com/a/55431032/3559724))
...
* **CarouselView** = scrollable list of uneven sizes items

...
* [Animations done right](https://www.youtube.com/watch?v=wnARLByOtKA) = SingleTickerProviderStateMixin, self-made sound-wave-looking sin animation
...
14. **StreamBuilder** = (re)build ~ (async) stream (events) (_initialData_, `snapshot.connectionState|data|error`, `snapshot.hasData|Error`)

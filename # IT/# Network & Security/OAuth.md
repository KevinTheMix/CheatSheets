...
OAuth (Open Authorization) is an open standard/prototol for scoped (ie partial) access delegation over HTTP, using access tokens rather than passing private passwords (aka _impersonation_)

...
* **.NET** (formerly **.NET Core**) = FOSS managed cross-platform (ie Windows, Linux and macOS) redesign & replacement of **.NET Framework**
  ...
  * _.NET 4.5_ (2012.08)
  * _.NET 4.6_ (2015.07)
  * _.NET Core 1.0_ (2016.06)
  * _.NET Core 1.1_ (2016.11)
  * _.NET 4.7_ (2017.05)
  * _.NET Core 2.0_ (2017.08)
  * _.NET Core 2.1_ (2018.05)
  * _.NET Core 2.2_ (2018.12)
  * _.NET 4.8_ (2019.04)
  * _.Net Core 3.0_ (2019.09) = introduces C# 8, and desktop technologies (UWP & WPF), prior to version 3, Core apps could run atop (target) either the .NET Core or good old .NET Framework runtime
  * _.Net Core 3.1_ (2019.12) = last version of _.NET Core_ under that denomination
  * _.NET 5_ (2020.11)
  * _.NET 6_ (2021.11)
  * _.NET 7_ (2022.11)
  * _.NET 8_ (2023.11)
...
* **Aspire** = developer-focused orchestration/observability layer for modern .NET distributed microservices applications, with DI-powered string-based name resolution discoverability at startup

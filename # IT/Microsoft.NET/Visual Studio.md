...
* _.editorconfig_ = general cross-editor configuration file standard for consistent coding guidelines/styles across editors (eg indent & whitespace chars, naming conventions)
